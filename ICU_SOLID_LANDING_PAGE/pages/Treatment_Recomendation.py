...
# Membuka beberapa file sekaligus dengan mode membaca biner ('rb') dan mengambil isi menggunakan pickle
with open(f'data/bestpol.pkl', 'rb') as file:
...
# Membuka file dengan mode membaca biner ('rb') dan mengambil isi menggunakan pickle
with open(f'data/step_5_start.pkl','rb') as file:
...
# Connect to MIMIC
con = psycopg2.connect(dbname=dbname, user=sqluser, password='anker2159')
cur = con.cursor()
...
WHERE ce.icustay_id IN (293325, 294638, 263738, 244882, 22555, 220597, 264490, 22944, 216859, 211552, 232669, 203487, 228232, 220597, 277042, 257980, 254478, 220597, 288409, 217847)
AND error != 1
...
#==============================================
options = 293325, 294638, 263738, 244882, 225555, 220597, 264490, 22944, 216859, 211552, 232669, 203487, 228232, 220597, 277042, 257980, 254478, 220597, 288409, 217847
